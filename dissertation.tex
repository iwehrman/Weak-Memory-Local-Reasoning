...
Graphical models are a simple but amazingly expressive formalism. Recent work has shown how they can be used to give various weak-memory semantics to concurrent programs \cite{DBLP:series/natosec/HoareW11}. 

 Concurrent Kleene Algebra \cite{DBLP:conf/RelMiCS/HoareMSW09,DBLP:conf/concur/HoareMSW09} Locality bimonoids \cite{DBLP:conf/concur/HoareHMOPS11} 
