...
Suppose, however, we had a modified notion of splitting permissions such that, as before, only locations with full 1 permission are writable, but also in which only locations with permission at least $\frac{1}{2}$ were allowed to have buffered writes. 
