...
In this chapter we briefly discuss a generalization of the sequential program logic described in the previous chapter. In particular, we refine the semantics of the $\fbaru$ assertion. Immediately, the changes we introduce will allow for a simpler sequential proof theory. They also constitute a necessary generalization for the multiprocessor model and concurrent program logic described in the next chapter. But because is possible to discuss this generalization in sequential setting, we shall do so for the sake of simplicity. 
