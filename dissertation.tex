...
It remains to show $\triple{x \fpointsto 1}{\cload{y}{x}}{x \fpointsto 1 \conj y = 1},$ but this, as we shall see, is an instance of the \textsc{load-mem} axiom scheme: \[ \infer[\textsc{load-mem}]{\triple{x \fpointsto 1}{\cload{y}{x}}{x \fpointsto 1 \conj y = 1}}{}\] which completes the derivation.

This completes the derivation of our original specification. 
...
\begin{enumerate}
    ...
    \item Right-hand temporal frame rule and the top predicate. 
\end{enumerate}
