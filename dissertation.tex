...
The satisfaction relation is defined by recursion on the structure of $P$ in Figure~\ref{fig:uniprocessor-satisfaction-relation}. 
...
Assertions can thus be thought of as syntactic constructs that denote sets of uniprocessor models, and hence sets of uniprocessor machine states. We now generalize the ordering on memory systems described in Section~\ref{sec:uniprocessor-predicates} to generalized memory systems: 
\begin{definition}
