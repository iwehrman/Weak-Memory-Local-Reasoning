...
The goal of this dissertation project is not to solve the full verification problem for racy programs executing on a weak memory model. The more modest goal of this dissertation project is instead, to take step in this direction by developing of a program logic for partial correctness verification by proof of C-like programs executing on an x86-like memory model. 
...
\Calc{
  ...
  \aconnt{$(\flock{0} \fsep (x = 0 \conj d \fpointsto s) \fsep (s = 1 \conj \femp)) \fseqri \fbar{0}$}
