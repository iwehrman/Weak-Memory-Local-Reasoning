...
Next, we must show $\spec{I}{\femp}{c_w \oppar c_r}{!x \disj y}$. We use the rule of consequence and a structural inference rule for the parallel composition of commands: \[ \infer{\vdots}{\infer[\textsc{cons}]{\spec{I}{\femp}{c_w \oppar c_r}{!x \disj y}}{\infer[\textsc{par}]{\spec{I}{\femp \fsep \femp}{c_w \oppar c_r}{\femp \fsep (!x \disj y)}}{\infer{\spec{I}{\femp}{c_w}{\femp}}{\vdots} & \infer{\spec{I}{\femp}{c_r}{!x \disj y}}{\vdots}}}}\] The \textsc{par} rule allows us to infer a combined specification from specifications of individual threads with matching invariants.  
