...
We call states like $\sigma_0$ for which the result of a load is determined by the relative ordering of the flushing operations \emph{unstable}. Conversely, states like $\sigma_1$ are called \emph{stable} because the result of loading is unaffected by the flushing operation. 
