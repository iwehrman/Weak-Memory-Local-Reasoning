...
\begin{proof}
  By induction on $n$. The base case is trivial. For the induction step, we assume the lemma holds for $n$ and show that it holds for $n+1$.
    ...
    \begin{enumerate}
        ...
        \item There are no aborting steps possible from command $\clock{e}$. 
