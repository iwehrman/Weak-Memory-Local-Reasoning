...
It can be convenient to make formal the distinction the partial and complete states. This allows us to add some additional structure to the partial states, which can enable a more flexible definition of the semantics of assertions, while the semantics of programs and their specifications may be restricted to just the complete states. 
