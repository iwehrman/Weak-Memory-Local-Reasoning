...
Graphical models \cite{DBLP:journals/ipl/WehrmanHO09} +Weak Memory\cite{DBLP:series/natosec/HoareW11} Concurrent Kleene Algebra \cite{DBLP:conf/RelMiCS/HoareMSW09,DBLP:conf/concur/HoareMSW09} Locality bimonoids \cite{DBLP:conf/concur/HoareHMOPS11} 
